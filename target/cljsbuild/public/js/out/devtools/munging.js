...
var o65120 = temp__5455__auto__;
var temp__5455__auto____$1 = (o65120["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o65121 = temp__5455__auto____$1;
return (o65121["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__51001__auto__ = f;
return (o__51001__auto__["toString"]).call(o__51001__auto__);
} else {
return "";
}
}catch (e65122){var _ = e65122;
return "";
}});
...
try{var o__51001__auto___65124 = t;
(o__51001__auto___65124["cljs$lang$ctorPrWriter"]).call(o__51001__auto___65124,t,writer);
}catch (e65123){var __65125 = e65123;
}
...
var char_code = (function (){var o__51001__auto__ = (new String(char$));
return (o__51001__auto__["charCodeAt"]).call(o__51001__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__51001__auto__ = String;
return (o__51001__auto__["fromCharCode"]).call(o__51001__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__65126 = num_code;
switch (G__65126) {
case (1):
return (185);
...
var o__51001__auto__ = String;
return (o__51001__auto__["fromCharCode"]).call(o__51001__auto__,superscript_code);
});
/**
...
}catch (e65128){var _e__51008__auto__ = e65128;
return false;
}})())){
...
var vec__65129 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__65129,(0),null);
...
var or__48579__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o65132 = temp__5455__auto__;
var temp__5455__auto____$1 = (o65132["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o65133 = temp__5455__auto____$1;
return (o65133["nameToPath"]);
} else {
return null;
}
} else {
...
var len__49858__auto___65140 = arguments.length;
var i__49859__auto___65141 = (0);
while(true){
if((i__49859__auto___65141 < len__49858__auto___65140)){
args__49865__auto__.push((arguments[i__49859__auto___65141]));

var G__65142 = (i__49859__auto___65141 + (1));
i__49859__auto___65141 = G__65142;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__49866__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__65136){
var vec__65137 = p__65136;
var ns_detector = cljs.core.nth.call(null,vec__65137,(0),null);
var effective_detector = (function (){var or__48579__auto__ = ns_detector;
if(cljs.core.truth_(or__48579__auto__)){
return or__48579__auto__;
} else {
...
var G__65143 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__65144 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__65143;
remaining_tokens = G__65144;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq65134){
var G__65135 = cljs.core.first.call(null,seq65134);
var seq65134__$1 = cljs.core.next.call(null,seq65134);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__65135,seq65134__$1);
});
...
var vec__65148 = cljs.core.split_with.call(null,(function (p1__65147_SHARP_){
return cljs.core.not_EQ_.call(null,p1__65147_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__65148,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__65148,(1),null);
...
var vec__65151 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__65151,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__65151,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__65154 = cljs.core.rest.call(null,remaining_tokens);
var G__65155 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__65154;
name_tokens = G__65155;
continue;
} else {
...
var vec__65158 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__65158,(0),null);
var arity = cljs.core.nth.call(null,vec__65158,(1),null);
var vec__65161 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__65161,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__65161,(1),null);
var vec__65164 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__65164,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__65164,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__65164,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__65164,(3),null);
...
var vec__65170 = result;
var munged_ns = cljs.core.nth.call(null,vec__65170,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__65170,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__65170,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__65170,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__65170,(4),null);
var arity = cljs.core.nth.call(null,vec__65170,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__65174 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__65174,(0),null);
var args = cljs.core.nth.call(null,vec__65174,(1),null);
var vec__65177 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__65177,(0),null);
var name = cljs.core.nth.call(null,vec__65177,(1),null);
...
var G__65180 = (arity + (1));
var G__65181 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__65182){
var vec__65183 = p__65182;
var arity = cljs.core.nth.call(null,vec__65183,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__65183,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__48579__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__48579__auto__)){
return or__48579__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__65186_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__65187_SHARP_);
...
var args__49865__auto__ = [];
var len__49858__auto___65194 = arguments.length;
var i__49859__auto___65195 = (0);
while(true){
if((i__49859__auto___65195 < len__49858__auto___65194)){
args__49865__auto__.push((arguments[i__49859__auto___65195]));

var G__65196 = (i__49859__auto___65195 + (1));
i__49859__auto___65195 = G__65196;
continue;
} else {
}
break;
...
var argseq__49866__auto__ = ((((1) < args__49865__auto__.length))?(new cljs.core.IndexedSeq(args__49865__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__49866__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__65190){
var vec__65191 = p__65190;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__65191,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq65188){
var G__65189 = cljs.core.first.call(null,seq65188);
var seq65188__$1 = cljs.core.next.call(null,seq65188);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__65189,seq65188__$1);
});
...
var G__65197 = arg;
var G__65197__$1 = (((G__65197 instanceof cljs.core.Keyword))?G__65197.fqn:null);
switch (G__65197__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__48579__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__48579__auto__)){
return or__48579__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__48567__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__48579__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__48579__auto__)){
return or__48579__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__65199__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__65199__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__65199__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__65199__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__65200 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__65200,(0),null);
var fn_name = cljs.core.nth.call(null,vec__65200,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__65200,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__65200,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__65200,(4),null);
var arity = cljs.core.nth.call(null,vec__65200,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__48567__auto__ = protocol_ns;
if(cljs.core.truth_(and__48567__auto__)){
return cljs.core.not.call(null,(function (){var and__48567__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__48579__auto__ = protocol_part;
if(cljs.core.truth_(or__48579__auto__)){
return or__48579__auto__;
} else {
return fn_part;
...
var o__51001__auto__ = f;
return (o__51001__auto__["getBasis"]).call(o__51001__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__48567__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__48567__auto__)){
...
}catch (e65204){var _e__51008__auto__ = e65204;
...
var G__65205 = (obj[cljs.core.first.call(null,path)]);
var G__65206 = cljs.core.rest.call(null,path);
obj = G__65205;
path = G__65206;
continue;
} else {
...
var partition_bits = (function (){var or__48579__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__48579__auto__)){
return or__48579__auto__;
} else {
return (0);
...
return (function (accum,p__65207){
var vec__65208 = p__65207;
var bit = cljs.core.nth.call(null,vec__65208,(0),null);
var protocol = cljs.core.nth.call(null,vec__65208,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__65211){
var vec__65212 = p__65211;
var ns = cljs.core.nth.call(null,vec__65212,(0),null);
var name = cljs.core.nth.call(null,vec__65212,(1),null);
var selector = cljs.core.nth.call(null,vec__65212,(2),null);
...
return (function (p__65216){
var vec__65217 = p__65216;
var munged_name = cljs.core.nth.call(null,vec__65217,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__65217,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__65217,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__65215_SHARP_){
return (obj[cljs.core.first.call(null,p1__65215_SHARP_)]);
});})(name,sorted_matches,vec__65217,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1515662035751
