...
var reader = (function (){var or__48579__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__48579__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__48579__auto__)){
return or__48579__auto__;
} else {
return (128);
...
var map__66956 = top_item;
var map__66956__$1 = ((((!((map__66956 == null)))?((((map__66956.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66956.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__66956):map__66956);
var file = cljs.core.get.call(null,map__66956__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__66956__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__66956__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e66955){var _e = e66955;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___66958 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___66958)){
var seen_errors_66959 = temp__5455__auto___66958;
if(cljs.core.truth_(seen_errors_66959.has(self))){
} else {
seen_errors_66959.add(self);

var temp__5457__auto___66960 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___66960)){
var sense_66961 = temp__5457__auto___66960;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_66961)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1515662038348
