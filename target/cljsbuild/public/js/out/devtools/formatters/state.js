...
var len__49858__auto___65242 = arguments.length;
var i__49859__auto___65243 = (0);
while(true){
if((i__49859__auto___65243 < len__49858__auto___65242)){
args__49865__auto__.push((arguments[i__49859__auto___65243]));

var G__65244 = (i__49859__auto___65243 + (1));
i__49859__auto___65243 = G__65244;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__49866__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq65240){
var G__65241 = cljs.core.first.call(null,seq65240);
var seq65240__$1 = cljs.core.next.call(null,seq65240);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__65241,seq65240__$1);
});
...
return (function (p1__65245_SHARP_){
return (p1__65245_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1515662036015
