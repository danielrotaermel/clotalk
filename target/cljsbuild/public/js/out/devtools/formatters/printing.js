...
var len__49858__auto___65251 = arguments.length;
var i__49859__auto___65252 = (0);
while(true){
if((i__49859__auto___65252 < len__49858__auto___65251)){
args__49865__auto__.push((arguments[i__49859__auto___65252]));

var G__65253 = (i__49859__auto___65252 + (1));
i__49859__auto___65252 = G__65253;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__49866__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq65248){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__65249,G__65250,seq65248__$2);
});
...
if(cljs.core.truth_((function (){var or__48579__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__49250__auto__,writer__49251__auto__,opt__49252__auto__){
return cljs.core._write.call(null,writer__49251__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__48567__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__48567__auto__){
var or__48579__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__48579__auto__)){
return or__48579__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__65254_SHARP_){
return !((cljs.core.meta.call(null,p1__65254_SHARP_) == null));
})))){
...
var map__65255 = opts;
var map__65255__$1 = ((((!((map__65255 == null)))?((((map__65255.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65255.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__65255):map__65255);
var markup_db = cljs.core.get.call(null,map__65255__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__48579__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e65259){var _e__51008__auto__ = e65259;
return false;
}})();
if(cljs.core.truth_(or__48579__auto__)){
return or__48579__auto__;
...
}catch (e65261){var _e__51008__auto__ = e65261;
return false;
}}
})())){
...
var _STAR_current_state_STAR_65263 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__65264 = opts;
var map__65264__$1 = ((((!((map__65264 == null)))?((((map__65264.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65264.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__65264):map__65264);
var markup_db = cljs.core.get.call(null,map__65264__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_65263;
}});
...
;
var temp__5455__auto___65268 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___65268)){
var managed_print_level_65269 = temp__5455__auto___65268;
var _STAR_print_level_STAR_65267_65270 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_65269;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_65267_65270,managed_print_level_65269,temp__5455__auto___65268,writer,opts,job_fn){
return (function (p1__65266_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__65266_SHARP_,null);
});})(_STAR_print_level_STAR_65267_65270,managed_print_level_65269,temp__5455__auto___65268,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_65267_65270;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1515662036132
