...
return clojure.string.join.call(null,(function (){var iter__49461__auto__ = (function markdown$lists$close_lists_$_iter__67628(s__67629){
return (new cljs.core.LazySeq(null,(function (){
var s__67629__$1 = s__67629;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__67629__$1);
if(temp__5457__auto__){
var s__67629__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__67629__$2)){
var c__49459__auto__ = cljs.core.chunk_first.call(null,s__67629__$2);
var size__49460__auto__ = cljs.core.count.call(null,c__49459__auto__);
var b__67631 = cljs.core.chunk_buffer.call(null,size__49460__auto__);
if((function (){var i__67630 = (0);
while(true){
if((i__67630 < size__49460__auto__)){
var vec__67632 = cljs.core._nth.call(null,c__49459__auto__,i__67630);
var list_type = cljs.core.nth.call(null,vec__67632,(0),null);
cljs.core.chunk_append.call(null,b__67631,["</li></",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,list_type)),">"].join(''));

var G__67638 = (i__67630 + (1));
i__67630 = G__67638;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__67631),markdown$lists$close_lists_$_iter__67628.call(null,cljs.core.chunk_rest.call(null,s__67629__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__67631),null);
}
} else {
var vec__67635 = cljs.core.first.call(null,s__67629__$2);
var list_type = cljs.core.nth.call(null,vec__67635,(0),null);
return cljs.core.cons.call(null,["</li></",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,list_type)),">"].join(''),markdown$lists$close_lists_$_iter__67628.call(null,cljs.core.rest.call(null,s__67629__$2)));
}
} else {
return null;
}
...
return iter__49461__auto__.call(null,lists);
})());
});
...
var lists_to_close = cljs.core.take_while.call(null,(function (p1__67639_SHARP_){
return (cljs.core.second.call(null,p1__67639_SHARP_) > num_indents);
...
var vec__67640 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__67640,(0),null);
var indents = cljs.core.nth.call(null,vec__67640,(1),null);
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ul","ul",-1349521403),list_type,num_indents,indents,(function (){var or__48579__auto__ = markdown.common.make_heading.call(null,content,false);
...
var vec__67643 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__67643,(0),null);
var indents = cljs.core.nth.call(null,vec__67643,(1),null);
var num_indents = cljs.core.count.call(null,cljs.core.take_while.call(null,cljs.core.partial.call(null,cljs.core._EQ_," "),text));
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ol","ol",932524051),list_type,num_indents,indents,(function (){var or__48579__auto__ = markdown.common.make_heading.call(null,content,false);
if(cljs.core.truth_(or__48579__auto__)){
return or__48579__auto__;
} else {
return content;
...
markdown.lists.li = (function markdown$lists$li(text,p__67646){
var map__67647 = p__67646;
var map__67647__$1 = ((((!((map__67647 == null)))?((((map__67647.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67647.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__67647):map__67647);
var state = map__67647__$1;
var code = cljs.core.get.call(null,map__67647__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__67647__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__67647__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.call(null,map__67647__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__67647__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
if(cljs.core.truth_((function (){var and__48567__auto__ = last_line_empty_QMARK_;
...
if(cljs.core.truth_((function (){var and__48567__auto__ = lists;
if(cljs.core.truth_(and__48567__auto__)){
var or__48579__auto__ = last_line_empty_QMARK_;
if(cljs.core.truth_(or__48579__auto__)){
return or__48579__auto__;
} else {
return eof;
...
var and__48567__auto____$1 = lists;
...
if(cljs.core.truth_((function (){var and__48567__auto__ = (function (){var or__48579__auto__ = eof;
if(cljs.core.truth_(or__48579__auto__)){
return or__48579__auto__;
} else {
...
//# sourceMappingURL=lists.js.map?rel=1515662039327
