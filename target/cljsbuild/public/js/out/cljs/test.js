...
return cljs.core.assoc.call(null,G__69051,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__69051;
}
});
...
var or__48579__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__49858__auto___69056 = arguments.length;
var i__49859__auto___69057 = (0);
while(true){
if((i__49859__auto___69057 < len__49858__auto___69056)){
args__49865__auto__.push((arguments[i__49859__auto___69057]));

var G__69058 = (i__49859__auto___69057 + (1));
i__49859__auto___69057 = G__69058;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__49866__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq69053){
var G__69054 = cljs.core.first.call(null,seq69053);
var seq69053__$1 = cljs.core.next.call(null,seq69053);
var G__69055 = cljs.core.first.call(null,seq69053__$1);
var seq69053__$2 = cljs.core.next.call(null,seq69053__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__69054,G__69055,seq69053__$2);
});
...
var file = cljs.core.get.call(null,map__69060__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__69060__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__69060__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__69060,map__69060__$1,file,line,column){
return (function (p1__69059_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__69059_SHARP_));
});})(map__69060,map__69060__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__49634__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__49634__auto__,prefer_table__49635__auto__,method_cache__49636__auto__,cached_hierarchy__49637__auto__,hierarchy__49638__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__48579__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__48579__auto__)){
return or__48579__auto__;
} else {
...
var temp__5457__auto___69062 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___69062)){
var message_69063 = temp__5457__auto___69062;
cljs.core.println.call(null,message_69063);
} else {
}
...
var temp__5457__auto___69064 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___69064)){
var message_69065 = temp__5457__auto___69064;
cljs.core.println.call(null,message_69065);
} else {
}
...
var output_dir = "target/cljsbuild/public/js/out";
var output_dir__$1 = (function (){var G__69066 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__69066),"/"].join('');
} else {
return G__69066;
}
})();
...
var temp__5455__auto__ = (function (){var and__48567__auto__ = typeof exception.stack === 'string';
if(and__48567__auto__){
var G__69068 = exception.stack;
var G__69068__$1 = (((G__69068 == null))?null:clojure.string.split_lines.call(null,G__69068));
var G__69068__$2 = (((G__69068__$1 == null))?null:cljs.core.get.call(null,G__69068__$1,depth));
if((G__69068__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__69068__$2);
}
} else {
...
var vec__69069 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__69069,(0),null);
var column = cljs.core.nth.call(null,vec__69069,(1),null);
var vec__69072 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__69072,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__69072,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__69072,(2),null);
...
var m__$1 = (function (){var G__69075 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__69075__$1 = (((G__69075 instanceof cljs.core.Keyword))?G__69075.fqn:null);
switch (G__69075__$1) {
case "fail":
...
var G__69079 = (function (){var G__69078 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__69078);
} else {
return G__69078;
}
})();
...
return cljs.core.vary_meta.call(null,G__69080,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__69084 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__69084,(0),null);
var types = vec__69084;
...
return cljs.core.map.call(null,(function (p__69087){
var vec__69088 = p__69087;
var ns = cljs.core.nth.call(null,vec__69088,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__69088,(1),null);
return ((function (vec__69088,ns,vars__$1){
return (function (){
...
var G__69091 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__69091,G__69091__$1,env,once_fixtures,each_fixtures,vec__69088,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__69091,G__69091__$1,env,once_fixtures,each_fixtures,vec__69088,ns,vars__$1){
return (function (){
var seq__69092 = cljs.core.seq.call(null,vars__$1);
var chunk__69093 = null;
var count__69094 = (0);
var i__69095 = (0);
while(true){
if((i__69095 < count__69094)){
var v = cljs.core._nth.call(null,chunk__69093,i__69095);
var temp__5457__auto___69097 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___69097)){
var t_69098 = temp__5457__auto___69097;
each_fixture_fn.call(null,((function (seq__69092,chunk__69093,count__69094,i__69095,t_69098,temp__5457__auto___69097,v,each_fixture_fn,G__69091,G__69091__$1,env,once_fixtures,each_fixtures,vec__69088,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_69098)));
});})(seq__69092,chunk__69093,count__69094,i__69095,t_69098,temp__5457__auto___69097,v,each_fixture_fn,G__69091,G__69091__$1,env,once_fixtures,each_fixtures,vec__69088,ns,vars__$1))
);
} else {
}

var G__69099 = seq__69092;
var G__69100 = chunk__69093;
var G__69101 = count__69094;
var G__69102 = (i__69095 + (1));
seq__69092 = G__69099;
chunk__69093 = G__69100;
count__69094 = G__69101;
i__69095 = G__69102;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__69092);
if(temp__5457__auto__){
var seq__69092__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__69092__$1)){
var c__49510__auto__ = cljs.core.chunk_first.call(null,seq__69092__$1);
var G__69103 = cljs.core.chunk_rest.call(null,seq__69092__$1);
var G__69104 = c__49510__auto__;
var G__69105 = cljs.core.count.call(null,c__49510__auto__);
var G__69106 = (0);
seq__69092 = G__69103;
chunk__69093 = G__69104;
count__69094 = G__69105;
i__69095 = G__69106;
continue;
} else {
var v = cljs.core.first.call(null,seq__69092__$1);
var temp__5457__auto___69107__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___69107__$1)){
var t_69108 = temp__5457__auto___69107__$1;
each_fixture_fn.call(null,((function (seq__69092,chunk__69093,count__69094,i__69095,t_69108,temp__5457__auto___69107__$1,v,seq__69092__$1,temp__5457__auto__,each_fixture_fn,G__69091,G__69091__$1,env,once_fixtures,each_fixtures,vec__69088,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_69108)));
});})(seq__69092,chunk__69093,count__69094,i__69095,t_69108,temp__5457__auto___69107__$1,v,seq__69092__$1,temp__5457__auto__,each_fixture_fn,G__69091,G__69091__$1,env,once_fixtures,each_fixtures,vec__69088,ns,vars__$1))
);
} else {
}

var G__69109 = cljs.core.next.call(null,seq__69092__$1);
var G__69110 = null;
var G__69111 = (0);
var G__69112 = (0);
seq__69092 = G__69109;
chunk__69093 = G__69110;
count__69094 = G__69111;
i__69095 = G__69112;
continue;
}
} else {
...
});})(each_fixture_fn,G__69091,G__69091__$1,env,once_fixtures,each_fixtures,vec__69088,ns,vars__$1))
);
});})(each_fixture_fn,G__69091,G__69091__$1,env,once_fixtures,each_fixtures,vec__69088,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__69091__$1)].join('')));

}
})());
});
;})(vec__69088,ns,vars__$1))
...
//# sourceMappingURL=test.js.map?rel=1515662041130
