...
clojure.test.check.clojure_test.assert_check = (function clojure$test$check$clojure_test$assert_check(p__69115){
var map__69116 = p__69115;
var map__69116__$1 = ((((!((map__69116 == null)))?((((map__69116.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69116.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__69116):map__69116);
var m = map__69116__$1;
var result = cljs.core.get.call(null,map__69116__$1,new cljs.core.Keyword(null,"result","result",1415092211));
cljs.core.prn.call(null,m);

if(cljs.core.truth_(clojure.test.check.impl.exception_like_QMARK_.call(null,result))){
throw result;
} else {
try{var value__56793__auto__ = result;
if(cljs.core.truth_(value__56793__auto__)){
cljs.test.do_report.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"pass","pass",1574159993),new cljs.core.Keyword(null,"expected","expected",1583670997),new cljs.core.Symbol(null,"result","result",-1239343558,null),new cljs.core.Keyword(null,"actual","actual",107306363),value__56793__auto__,new cljs.core.Keyword(null,"message","message",-406056002),null], null));
} else {
...
var begin_test_var_method_69120 = cljs.core.get_method.call(null,cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"begin-test-var","begin-test-var",-908571100)], null));
cljs.core._add_method.call(null,cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"begin-test","begin-test",1831272774)], null),((function (begin_test_var_method_69120){
return (function (m){
...
if(cljs.core.truth_(begin_test_var_method_69120)){
return begin_test_var_method_69120.call(null,m);
} else {
return null;
}
});})(begin_test_var_method_69120))
);
clojure.test.check.clojure_test.get_property_name = (function clojure$test$check$clojure_test$get_property_name(p__69121){
var map__69122 = p__69121;
var map__69122__$1 = ((((!((map__69122 == null)))?((((map__69122.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69122.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__69122):map__69122);
var report_map = map__69122__$1;
var property_fun = cljs.core.get.call(null,map__69122__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","property","clojure.test.check.clojure-test/property",1356517781));
var or__48579__auto__ = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,property_fun));
 ...
 */
clojure.test.check.clojure_test.trial_report_dots = (function clojure$test$check$clojure_test$trial_report_dots(p__69124){
var map__69125 = p__69124;
var map__69125__$1 = ((((!((map__69125 == null)))?((((map__69125.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69125.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__69125):map__69125);
var vec__69126 = cljs.core.get.call(null,map__69125__$1,new cljs.core.Keyword("clojure.test.check.clojure-test","trial","clojure.test.check.clojure-test/trial",866433060));
var so_far = cljs.core.nth.call(null,vec__69126,(0),null);
var total = cljs.core.nth.call(null,vec__69126,(1),null);
if((so_far > (0))){
...
var temp__5457__auto__ = (function (){var and__48567__auto__ = clojure.test.check.clojure_test._STAR_report_trials_STAR_;
...
//# sourceMappingURL=clojure_test.js.map?rel=1515662041184
