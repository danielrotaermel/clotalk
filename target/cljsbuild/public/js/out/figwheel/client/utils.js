...
var or__48579__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj72095 = {"detail":data};
return obj72095;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__48567__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__48567__auto__)){
var and__48567__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__72102 = cljs.core._EQ_;
var expr__72103 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__72102.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__72103))){
return ((function (pred__72102,expr__72103){
return (function (p1__72096_SHARP_){
return console.warn(p1__72096_SHARP_);
});
;})(pred__72102,expr__72103))
} else {
if(cljs.core.truth_(pred__72102.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__72103))){
return ((function (pred__72102,expr__72103){
return (function (p1__72097_SHARP_){
return console.debug(p1__72097_SHARP_);
});
;})(pred__72102,expr__72103))
} else {
if(cljs.core.truth_(pred__72102.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__72103))){
return ((function (pred__72102,expr__72103){
return (function (p1__72098_SHARP_){
return console.error(p1__72098_SHARP_);
});
;})(pred__72102,expr__72103))
} else {
return ((function (pred__72102,expr__72103){
return (function (p1__72099_SHARP_){
return console.log(p1__72099_SHARP_);
});
;})(pred__72102,expr__72103))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__72106){
var map__72107 = p__72106;
var map__72107__$1 = ((((!((map__72107 == null)))?((((map__72107.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__72107.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__72107):map__72107);
var opts = map__72107__$1;
var eval_fn = cljs.core.get.call(null,map__72107__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__72109_SHARP_);
});})(new_def))
);
...
return (function (p__72110){
var vec__72111 = p__72110;
var ky = cljs.core.nth.call(null,vec__72111,(0),null);
var v = cljs.core.nth.call(null,vec__72111,(1),null);
...
if(cljs.core.truth_((function (){var and__48567__auto__ = typeof localStorage !== 'undefined';
...
}catch (e72116){if((e72116 instanceof Error)){
var e = e72116;
return not_found;
} else {
throw e72116;
...
//# sourceMappingURL=utils.js.map?rel=1515662043641
