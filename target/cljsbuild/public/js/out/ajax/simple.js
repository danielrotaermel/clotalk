...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__67390){
...
var handler = cljs.core.get.call(null,map__67391__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return (function (p1__67393_SHARP_){
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__48579__auto__ = p1__67393_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__67394){
var map__67395 = p__67394;
var map__67395__$1 = ((((!((map__67395 == null)))?((((map__67395.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67395.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__67395):map__67395);
var request = map__67395__$1;
var interceptors = cljs.core.get.call(null,map__67395__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__48579__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__48579__auto__)){
return or__48579__auto__;
} else {
...
//# sourceMappingURL=simple.js.map?rel=1515662038976
